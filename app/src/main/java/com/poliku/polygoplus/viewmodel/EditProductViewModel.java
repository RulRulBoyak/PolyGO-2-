...
public class EditProductViewModel extends ViewModel {
    ...
    public void setCategory(String val) { state.set("cat", val); }
    public String getCategory() { return state.get("cat"); }

    public void setDescription(String val) { state.set("desc", val); }
    public String getDescription() { return state.get("desc"); }

    public void setLocation(String val) { state.set("loc", val); }
    public String getLocation() { return state.get("loc") != null ? state.get("loc") : "Near campus"; }
}
